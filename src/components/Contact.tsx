        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h4 className="text-xl font-semibold text-gray-800">Follow Our YouTube Channels</h4>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-orange-100 shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer">
                <CardContent className="p-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h5 className="font-medium text-gray-800">Sharvari's Healthy Kitchen Hindi</h5>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-orange-100 shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer">
                <CardContent className="p-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h5 className="font-medium text-gray-800">Sharvari's Healthy Kitchen Marathi</h5>
