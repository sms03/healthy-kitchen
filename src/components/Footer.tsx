      ...
      <div className="relative z-10 container mx-auto px-6 py-16">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12 mb-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Culinary Excellence Since 2020</p>
              </div>
            </div>
            <p className="text-gray-300 text-lg leading-relaxed max-w-md">
              Crafting delicious, healthy, and innovative recipes for food lovers everywhere. 
              From traditional flavors to modern twists, every dish tells a story.
            </p>
            
            {/* Social Media Links */}
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-orange-500 transition-all duration-300 group">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {['Home', 'About', 'Menu', 'Contact', 'Catering', 'Reviews'].map((link) => (
                <a 
                  key={link}
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3 text-gray-300">
                ...
                <span>sharvari@healthykitchen.com</span>
              </div>
              <div className="flex items-center space-x-3 text-gray-300">
                <div className="w-8 h-8 bg-orange-500/20 rounded-lg flex items-center justify-center">
        ...
        <div className="border-t border-gray-700 pt-8 mb-8">
          <div className="text-center space-y-4">
            <h4 className="text-xl font-semibold">Stay Updated with Our Latest Recipes</h4>
            <p className="text-gray-400">Subscribe to get weekly meal inspirations and special offers</p>
            <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input 
                type="email" 
                placeholder="Enter your email"
                className="flex-1 px-4 py-3 bg-white/10 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-orange-400 transition-colors"
              />
              <button className="px-6 py-3 bg-gradient-to-r from-orange-500 to-red-600 rounded-lg font-medium hover:from-orange-600 hover:to-red-700 transition-all duration-300 transform hover:scale-105">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-400 flex items-center justify-center space-x-2 text-sm">
            ...
            <span>by Sharvari Salunkhe © 2024. All rights reserved.</span>
          </p>
